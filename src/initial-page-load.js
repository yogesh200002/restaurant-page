...
function mainCreation() {
  ...
  homeContent.textContent =
    "We are number one in serving mouth watery south indian dishes all over in India Since 2000. We offer wide varieties of dishes and sweets which we are known for.";
